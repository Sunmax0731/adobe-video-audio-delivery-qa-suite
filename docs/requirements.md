...
Adobe動画・音声納品検品スイート は、動画・音声案件は字幕、MOGRT、AE依存、エンコード、音量検査が別々になり手戻りが出やすい。 という課題を、Premiere Pro panel concept + evidence CLI で解決する。
...
- media delivery check を JSON 入力で受け取り、必須項目を検証できる。
